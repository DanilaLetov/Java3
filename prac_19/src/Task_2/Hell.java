...
import static Task_2.Student.AVG_COMP;
...
public class Hell extends JFrame {
    ...
    public Hell(ArrayList<Student> students){
        // base
        super("Студенты");
